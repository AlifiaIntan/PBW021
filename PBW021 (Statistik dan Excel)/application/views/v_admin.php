...
<p align="center"><a href="<?php echo site_url('report'); ?>">report</a>
<p align="center"><a href="<?php echo base_url('login/logout'); ?>">Logout</a>

  <?php echo anchor('admin/export','Export ke Excel'); ?></p>
